                ...
                <section className="rounded-xl border border-amber-200 bg-amber-50 p-4 md:p-5">
                  <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="text-lg font-semibold text-gray-900">Your rental is completed</h3>
                        <p className="text-sm text-gray-600">Leave a review to help other renters and share your experience.</p>
                      </div>
                    </div>
                    <Link
                      to="/reviews"
